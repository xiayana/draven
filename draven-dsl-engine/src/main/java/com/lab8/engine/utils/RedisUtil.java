...
public class RedisUtil {
     ...
     */
    public void hmset(@Nonnull String key, Map<String, Object> map) {
     ...
     * @return true成功 false失败
     */
    public boolean hmset(@Nonnull String key, Map<String, Object> map, long time) {
        redisTemplate.opsForHash().putAll(key, map);
        if (time > 0) {
            expire(key, time);
        }
     ...
     */
    public void hset(@Nonnull String key, String item, Object value) {
     ...
     * @return 成功个数
     */
    public long sSetAndTime(@Nonnull String key, long time, Object... values) {
     ...
     * @return
     */
    public boolean lSet(@Nonnull String key, Object value) {
     ...
     * @return
     */
    public boolean lSet(@Nonnull String key, Object value, long time) {
     ...
     * @return
     */
    public boolean lSet(@Nonnull String key, List<Object> value) {
